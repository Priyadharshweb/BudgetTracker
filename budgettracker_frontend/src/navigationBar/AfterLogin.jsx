...
const AfterLogin = () => {
  ...
  const handleBudget=()=>navigate('/budget');
  const handleSavings=()=>navigate('/savings');
      ...
      <div className="nav-left">
        ...
        <ul className="nav-links">
          <li 
            ...
            style={{
              backgroundColor: location.pathname === '/userDashboard' ? 'rgb(52, 101, 109)' : 'transparent',
              color: location.pathname === '/userDashboard' ? 'white' : '#666',
              borderRadius: '25px',
              padding: '8px 16px',
          ...
          <li 
            ...
            style={{
              backgroundColor: location.pathname === '/transaction' ? 'rgb(52, 101, 109)' : 'transparent',
              color: location.pathname === '/transaction' ? 'white' : '#666',
              borderRadius: '25px',
              padding: '8px 16px',
              transition: 'all 0.3s ease',
              cursor: 'pointer'
